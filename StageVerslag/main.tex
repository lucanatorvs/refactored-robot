...
\title{Eindverslag \textbf{Stage EV Europe}}
\subtitle{CCS DC Snelladen van Accupakketten voor Elektrische Auto's}
...
\begin{versionhistory}
    \vhEntry{V0.1}{08.12.2021}{Luca}{Document aangemaakt}
    \vhEntry{V0.2}{20.01.2022}{Luca}{Eerte proefversie}
    \vhEntry{V0.3}{2.02.2022}{Luca}{Tweede proefversie}
    \vhEntry{V0.4}{8.02.2022}{Luca}{Derde proefversie/Spelcheck}
    \vhEntry{V1.0}{9.02.2022}{Luca}{Eerstre versie}
\end{versionhistory}
...
\label{code} % dit is een document voor de opdrachtgever
\includepdf[pages=-,fitpaper,rotateoversize]{Appendices/code/CAN_convertor.ino.pdf}
\end{appendices}
